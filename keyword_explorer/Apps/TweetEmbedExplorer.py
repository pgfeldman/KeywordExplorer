...
class EmbeddingsExplorer(AppBase):
    ...
    def build_create_corpora_tab(self, tab: ttk.Frame):
        ...
        ToolTip(cb, "Excludes tweets that are in threads connected\nto a tweet containing the keyword")
        ...
        ToolTip(cb, "Adds the tweet author's self-description to the tweet meta-wrapping")
        ...
        ToolTip(cb, "Check to place the meta-wrapping before the tweet text")
        ...
        ToolTip(cb, "Generate a single test/train set with all keywords in it\nrather than a separate test/trin file for each keyword")
        ...
        ToolTip(cb, "Disable the generation of percent values in the meta-wrapping to determine learning accuracy (10%, 20%, 30%, 40%")
        ...
        ToolTip(cb, "Include all clusters that were flagged for exclusion")
