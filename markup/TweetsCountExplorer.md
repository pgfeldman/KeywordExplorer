#TweetCountExplorer
_TweetCountExplorer_ is a standalone app that has just the Twitter trends section from [_KeywordExplorer_](../markup/KeywordExplorer.md). Below is an example of the running app:
