...
* _ModelExplorer_ requires GPT-2 models trained on corpora generated by _TweetEmbed_explorer_. To train a model, follows these steps: [How to train a model](./markup/model_train.md)
