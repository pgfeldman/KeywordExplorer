...
from table_parsed_text pt
         inner join table_run tr on pt.run_index = tr.id
...
from table_run r
         inner join table_parsed_text pt on r.id = pt.run_index
...
from table_experiment e
         ...
         inner join table_parsed_text p on r.run_id = p.run_index
