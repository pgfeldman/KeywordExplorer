...
--
-- Temporary table structure for view `parsed_text_view`
--

DROP TABLE IF EXISTS `parsed_text_view`;
/*!50001 DROP VIEW IF EXISTS `parsed_text_view`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `parsed_text_view` (
  `id` tinyint NOT NULL,
...
CREATE TABLE `table_parsed_text` (
  ...
  `moderation` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=99413 DEFAULT CHARSET=latin1;
...
CREATE TABLE `table_source` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=latin1 COMMENT='The source doc for the parsed text';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `table_summary_text` (
  ...
  `moderation` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17170 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Final view structure for view `parsed_text_view`
--

/*!50001 DROP TABLE IF EXISTS `parsed_text_view`*/;
/*!50001 DROP VIEW IF EXISTS `parsed_text_view`*/;
...
/*!50001 VIEW `parsed_text_view` AS select `t`.`id` AS `id`,`t`.`source` AS `source`,`s`.`text_name` AS `text_name`,`t`.`parsed_text` AS `parsed_text` from (`table_parsed_text` `t` join `table_source` `s` on((`t`.`source` = `s`.`id`))) */;
...
-- Dump completed on 2023-07-14  7:48:59
